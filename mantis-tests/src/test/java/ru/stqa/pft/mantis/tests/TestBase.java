...
public class TestBase {
  ...
  public void setUp() throws IOException {
    app.init();
    app.ftp().upload(new File("C:\\GITHUB\\trainings\\softwareTesting.JavaLearning\\mantis-tests\\src\\test\\resources\\config_inc.php"), "config_inc.php", "config_inc.php.bak");
  }
